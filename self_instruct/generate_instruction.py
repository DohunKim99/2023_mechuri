...
from ChatCompletion import CreateCompletions
...
if __name__ == "__main__":
    ...
    if os.path.exists(os.path.join(args.out_dir, "generated_data.jsonl")):
        with open(os.path.join(args.out_dir, "generated_data.jsonl"), "r", encoding="utf-8") as fin:
            for l in fin:
                tmp = json.loads(l) 
    ...
    # with open(os.path.join(args.batch_dir, "generated_data.jsonl"), "a", encoding="utf-8") as fout:
    while len(machine_instructions) < args.num_instructions_to_generate:
        ...
        for instruction_data_entry in instruction_data:
            ...
            with open(os.path.join(args.out_dir, "generated_data.jsonl"), "a", encoding="utf-8") as fout:
